...
export const registerNewUser = (username,role_type,userId) => {
...
export const removeNewUser = (username,role_type,userId) => {
  socket?.emit('remove-new-user', {
    username: username,
    socketId: socket.id,
    role_type:role_type,
    userId:userId
